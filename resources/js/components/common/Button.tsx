...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  return (
    ...
    >
      {isLoading && (
        <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-current motion-reduce:animate-[spin_2s_linear_infinite]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
